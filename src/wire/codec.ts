...
import { encodeGgep, parseGgep, type GgepItem } from "./ggep";
import type {
  DescriptorHeader,
  QueryEncodeOptions,
...
export { parseHttpDownloadHeader } from "../transfers/http_download_header";
...
/** Prefix payload bytes with a Gnutella descriptor header. */
...
/** Decode a fixed-length descriptor header. */
...
/** Encode endpoint and shared-file statistics as a pong. */
...
/** Decode a pong's endpoint, statistics, and extensions. */
...
/** Encode query text, flags, and content extensions. */
...
/** Decode query text, flags, URNs, and metadata. */
...
/** Encode matching files and the responding servent identity. */
...
/** Decode result files, metadata, and servent identity. */
...
/** Encode a push callback request for a shared file. */
...
/** Decode a push request's target and callback endpoint. */
...
/** Encode a disconnect code and explanation. */
...
/** Decode a disconnect code and explanation. */
...
/** Decode a QRP reset or patch message. */
...
/** Build an indexed file GET with optional resume offset. */
...
/** Build a content-URN GET with optional resume offset. */
