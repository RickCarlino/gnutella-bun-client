...
/** Split accent-folded text into lowercase terms. */
...
/** Expand QRP terms with shortened prefixes. */
...
/** Check whether enough query terms are present. */
...
/** Check whether a QRP slot indicates presence. */
