...
/** Advertise local identity, role, and supported features. */
...
/** Interpret remote handshake features and capabilities. */
export function buildPeerCapabilities(
  ...
  return {
    ...
    isCrawler: !!h.crawler,
    listenIp:
      parseListenIpHeader(h["listen-ip"]) ?? parseListenIpHeader(h.node),
  };
}
