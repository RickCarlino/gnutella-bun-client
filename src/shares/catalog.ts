...
/** Check whether cached size and modification time match. */
...
/** Reuse a cached hash only when file metadata matches. */
...
/** Copy hash metadata into a share and catalog entry. */
...
/** Index scanned files, reuse hashes, and list hash work. */
