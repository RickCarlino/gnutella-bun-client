...
import { rankPeerCandidatesByLastSeen } from "../discovery";
import {
  normalizeIpv4,
  normalizePeer,
  parsePeer,
...
/** Normalize saved endpoints and their last-seen times. */
...
/** List normalized peers from newest to oldest. */
...
/** Keep only the most recent remembered peers. */
...
/** Remove blocked hosts from remembered peers. */
...
/** Remember an endpoint without reducing its timestamp. */
